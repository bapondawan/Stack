...
const StackFlow = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-red-600 to-blue-800 min-h-[100vh]">
      <div className="container flex text-center m-auto bg-gray-200 w-[100vw] h-14 ">
        <div className="nav float-left fixed relative block bg-gray-200 w-[100vw] h-14 ">
          <button className="float-left" id="buttonfro" onClick={Bapon}>
      ...
      <div className=" flex text-center container bg-gray-600 rounded w-[90vw] h-[100vh]">
